...
const AboutUs = () => {
  return (
    <MainLayout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg opacity-90">
              Mengenal lebih dekat dengan Cahaya Artikel Indonesia, platform artikel Islami terpercaya
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-900 islamic-pattern">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <a
                    href="#"
                    className="w-8 h-8 rounded-full bg-islamic-green/10 flex items-center justify-center text-islamic-green hover:bg-islamic-green/20 transition-colors"
                  >
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-2 text-islamic-navy dark:text-white">
              Inspirasi dari <span className="text-islamic-green">AKUDAV</span>
            </h2>
            <div className="w-24 h-1 bg-islamic-gold mx-auto"></div>
            <p className="mt-4 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Nikmati konten seru dan kreatif dari AKUDAV, kanal YouTube gaming yang menginspirasi komunitas kami
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative rounded-lg overflow-hidden shadow-lg">
              <iframe
                width="100%"
                height="450"
                src="https://www.youtube.com/embed/dQw4w9WgXcQ" // Placeholder; replace with AKUDAV video ID
                title="AKUDAV Video"
                frameBorder="0"
