      ...
      <div className="bg-gradient-to-b from-islamic-navy to-blue-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col sm:flex-row items-center justify-between mb-8">
            <Link
              to="/articles"
              className="flex items-center text-islamic-gold hover:text-amber-400 transition-colors duration-300 group"
            >
            ...
            <Link
              ...
              className="mt-4 sm:mt-0 flex items-center bg-islamic-green/90 text-white px-4 py-2 rounded-lg hover:bg-islamic-green shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
            >
              <Edit className="h-5 w-5 mr-2" />
              Edit Artikel
            </Link>
          </div>
          <h1 className="text-4xl sm:text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-islamic-gold to-amber-300">
            {article.title}
          </h1>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          ...
          {recentArticles.length > 0 && (
            <div className="mt-16 max-w-4xl mx-auto">
              <h3 className="text-3xl font-bold mb-8 text-islamic-navy dark:text-white border-l-4 border-islamic-green pl-4">
                Artikel Terkait
              </h3>
