    ...
    <article className="max-w-3xl mx-auto">
      <div className="mb-8">
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-islamic-green/10 text-islamic-green dark:bg-islamic-green/20 dark:text-islamic-gold text-sm px-3 py-1 rounded-full">{article.category}</span>
        </div>
        <h1 className="text-3xl md:text-4xl font-bold mb-4 text-islamic-navy dark:text-white">{article.title}</h1>
      ...
      <div className="relative h-72 sm:h-96 mb-8 rounded-lg overflow-hidden">
        <LazyLoadImage src={article.image} alt={article.title} effect="blur" className="w-full h-full object-cover" placeholderSrc="/placeholder.jpg" />
